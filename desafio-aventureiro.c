...
// 3. Funções Auxiliares (Mesmas do Nível Novato)
void adicionar_item()
{
...
void remover_item()
{
    ...
    //4. Busca Sequencial para remoção
    for (int i = 0; i < num_itens; i++)
    {
    ...
    {
        //5. Deslocamento dos itens (Lógica de remoção)
...
// 6. Implementação da nova funcionalidade: Buscar Item
void buscar_item()
{
    if (num_itens == 0)
    {
...
// 7. Função Principal e Menu Interativo
int main()
{
    int opcao;
