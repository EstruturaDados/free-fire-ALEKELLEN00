...
// Converte uma string inteira para minúsculas (para busca e ordenação case-insensitive)
...
void adicionar_item() {
    ...
    num_itens++;
    // Resetar o estado de ordenação após a inserção
...
void remover_item() {
    ...
    // Busca Sequencial (simples e robusta para remoção)
    for (int i = 0; i < num_itens; i++) {
